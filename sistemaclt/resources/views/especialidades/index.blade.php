...
@section('content')
    ...
    <div class="text-center mb-4">
        <h2 class="text-uppercase fw-bold text-danger">GESTIÓN DE ESPECIALIDADES</h2>
    </div>

    <div class="mb-3 text-end">
        <button class="btn btn-success btn-nueva-especialidad" data-bs-toggle="modal" data-bs-target="#modalEspecialidad">+
            Nueva Especialidad</button>
    </div>
